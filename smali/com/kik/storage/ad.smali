.class public final Lcom/kik/storage/ad;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/kik/storage/ad$a;,
        Lcom/kik/storage/ad$b;
    }
.end annotation


# instance fields
.field private final a:Lcom/kik/storage/ad$b;
...
.method public constructor <init>(Lkik/core/interfaces/ac;Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/kik/storage/ad;->b:Ljava/util/concurrent/locks/ReentrantReadWriteLock;

    .line 34
    iget-object v0, p0, Lcom/kik/storage/ad;->b:Ljava/util/concurrent/locks/ReentrantReadWriteLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock;->readLock()Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;

    move-result-object v0

    iput-object v0, p0, Lcom/kik/storage/ad;->c:Ljava/util/concurrent/locks/Lock;
    ...
    iput-object v0, p0, Lcom/kik/storage/ad;->d:Ljava/util/concurrent/locks/Lock;

    .line 39
    new-instance v0, Lcom/kik/storage/ad$b;

    invoke-interface {p1}, Lkik/core/interfaces/ac;->q()Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, p2, v1}, Lcom/kik/storage/ad$b;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcom/kik/storage/ad;->a:Lcom/kik/storage/ad$b;
...
.method private varargs a([Lcom/kik/core/network/xmpp/jid/a;)Ljava/util/List;
    ...
    .line 92
    iget-object v1, p0, Lcom/kik/storage/ad;->c:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v1}, Ljava/util/concurrent/locks/Lock;->lock()V

    .line 93
    iget-object v1, p0, Lcom/kik/storage/ad;->a:Lcom/kik/storage/ad$b;

    invoke-virtual {v1}, Lcom/kik/storage/ad$b;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 98
    const-class v0, Lcom/kik/storage/ad$a;
    ...
    check-cast v0, Lcom/kik/storage/ad$a;

    .line 100
    invoke-static {v3, v4, v5}, Lcom/kik/storage/ae;->a(Ljava/util/List;Ljava/util/List;Lcom/kik/core/network/xmpp/jid/a;)Lcom/kik/storage/o$a;

    move-result-object v5

    invoke-virtual {v0, v5}, Lcom/kik/storage/ad$a;->a(Lcom/kik/storage/o$a;)V
    :try_end_0
    ...
    .line 113
    :cond_0
    iget-object v0, p0, Lcom/kik/storage/ad;->c:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/Lock;->unlock()V

    .line 115
    invoke-virtual {p0, v4}, Lcom/kik/storage/ad;->b(Ljava/util/List;)I
...
.method public final a(Lcom/kik/core/network/xmpp/jid/a;)Z
    ...
    invoke-virtual {p0, v2}, Lcom/kik/storage/ad;->b(Ljava/util/List;)I
...
.method public final a(Ljava/util/List;)Z
    ...
    .line 50
    :cond_0
    iget-object v0, p0, Lcom/kik/storage/ad;->d:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/Lock;->lock()V

    .line 51
    iget-object v0, p0, Lcom/kik/storage/ad;->a:Lcom/kik/storage/ad$b;

    invoke-virtual {v0}, Lcom/kik/storage/ad$b;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v5, v0}, Lcom/kik/storage/ad$a;->a(Lcom/kik/core/network/xmpp/jid/a;[B)Landroid/content/ContentValues;
    ...
    .line 71
    iget-object v1, p0, Lcom/kik/storage/ad;->d:Ljava/util/concurrent/locks/Lock;
...
.method public final b(Ljava/util/List;)I
    ...
    .line 139
    invoke-static {v3, v0}, Lcom/kik/storage/ad;->a(Landroid/database/sqlite/SQLiteDatabase;Lcom/kik/core/network/xmpp/jid/a;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final b(Lcom/kik/core/network/xmpp/jid/a;)Lcom/kik/entity/model/EntityCommon$EntityUserRosterEntry;
    ...
    invoke-direct {p0, v0}, Lcom/kik/storage/ad;->a([Lcom/kik/core/network/xmpp/jid/a;)Ljava/util/List;
