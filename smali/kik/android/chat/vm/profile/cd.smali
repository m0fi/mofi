.class public final Lkik/android/chat/vm/profile/cd;
...
.field private C:Lkik/android/chat/vm/chats/profile/ds;
...
.field p:Lkik/core/interfaces/af;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.field r:Lkik/core/interfaces/ac;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.field private z:Lkik/android/chat/vm/dz;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(Lcom/kik/core/network/xmpp/jid/a;Lkik/core/datatypes/MemberPermissions;Z)V
    ...
    iput-object v0, p0, Lkik/android/chat/vm/profile/cd;->z:Lkik/android/chat/vm/dz;

    .line 104
    invoke-static {}, Lkik/android/chat/vm/profile/ce;->a()Lrx/functions/h;

    move-result-object v0

    iput-object v0, p0, Lkik/android/chat/vm/profile/cd;->E:Lrx/functions/h;

    .line 123
    iput-boolean p3, p0, Lkik/android/chat/vm/profile/cd;->y:Z

    .line 124
    iput-object p2, p0, Lkik/android/chat/vm/profile/cd;->x:Lkik/core/datatypes/MemberPermissions;
...
.method private J()Lkik/core/datatypes/k;
    ...
    .prologue
    .line 461
    invoke-virtual {p0}, Lkik/android/chat/vm/profile/cd;->p()Lcom/kik/core/network/xmpp/jid/a;
...
.method static synthetic a(Lkik/android/chat/vm/profile/cd;Lcom/kik/core/domain/a/a/c;)Ljava/lang/String;
    .locals 5
    ...
    invoke-virtual {p0, v1, v2}, Lkik/android/chat/vm/profile/cd;->a(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method static synthetic a(Lkik/android/chat/vm/profile/cd;)V
    .locals 3

    .prologue
    .line 357
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->d:Lcom/kik/android/Mixpanel;
    ...
    .line 358
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->t:Lkik/android/videochat/c;
    ...
    .line 359
    invoke-virtual {p0}, Lkik/android/chat/vm/profile/cd;->H_()Lkik/android/chat/vm/bd;
    ...
    .line 360
    invoke-virtual {p0}, Lkik/android/chat/vm/profile/cd;->ag_()Lrx/f/b;

    move-result-object v0

    iget-object v1, p0, Lkik/android/chat/vm/profile/cd;->k:Lcom/kik/core/domain/a/b;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cx;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/a;
...
.method static synthetic a(Lkik/android/chat/vm/profile/cd;Lcom/kik/core/domain/users/a/c;Lcom/kik/core/domain/a/a/c;)V
    .locals 4
    ...
    iget-object v3, p0, Lkik/android/chat/vm/profile/cd;->A:Lrx/d;

    invoke-virtual {p0, v0, v1, v2, v3}, Lkik/android/chat/vm/profile/cd;->a(Lkik/android/chat/a/a$b;Lcom/kik/core/network/xmpp/jid/a;Ljava/lang/String;Lrx/d;)V
...
.method static synthetic a(Lkik/android/chat/vm/profile/cd;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cw;->a(Lkik/android/chat/vm/profile/cd;)Ljava/lang/Runnable;
    ...
    .line 367
    invoke-virtual {p0, v1}, Lkik/android/chat/vm/profile/cd;->a(I)Ljava/lang/String;
...
.method static synthetic a(Lkik/android/chat/vm/profile/cd;Ljava/util/List;)V
    .locals 6
    ...
    .line 6267
    iget-object v2, p0, Lkik/android/chat/vm/profile/cd;->z:Lkik/android/chat/vm/dz;
    ...
    iget-object v4, p0, Lkik/android/chat/vm/profile/cd;->A:Lrx/d;

    invoke-static {p0}, Lkik/android/chat/vm/profile/ci;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/c;
...
.method static synthetic b(Lkik/android/chat/vm/profile/cd;)V
    .locals 1
...
.method static synthetic b(Lkik/android/chat/vm/profile/cd;Lcom/kik/core/domain/a/a/c;)V
    .locals 7
    ...
    .line 386
    iget-object v1, p0, Lkik/android/chat/vm/profile/cd;->u:Lkik/core/interfaces/ICommunication;
    ...
    iget-object v1, p0, Lkik/android/chat/vm/profile/cd;->p:Lkik/core/interfaces/af;

    invoke-interface {v1}, Lkik/core/interfaces/af;->d()Lkik/core/datatypes/aa;

    move-result-object v1

    iget-object v2, p0, Lkik/android/chat/vm/profile/cd;->d:Lcom/kik/android/Mixpanel;

    iget-object v3, p0, Lkik/android/chat/vm/profile/cd;->v:Lkik/core/interfaces/b;

    invoke-interface {p1}, Lcom/kik/core/domain/a/a/c;->b()Ljava/lang/String;

    move-result-object v5

    new-instance v6, Lkik/android/chat/vm/profile/cd$1;

    invoke-direct {v6, p0}, Lkik/android/chat/vm/profile/cd$1;-><init>(Lkik/android/chat/vm/profile/cd;)V

    invoke-interface/range {v0 .. v6}, Lkik/android/chat/vm/bd;->a(Lkik/core/datatypes/aa;Lcom/kik/android/Mixpanel;Lkik/core/interfaces/b;Lcom/kik/events/Promise;Ljava/lang/String;Lkik/android/f/h;)V

    .line 416
    return-void
.end method

.method static synthetic c(Lkik/android/chat/vm/profile/cd;)V
    .locals 4
    ...
    .line 3478
    invoke-virtual {p0, v3}, Lkik/android/chat/vm/profile/cd;->a(I)Ljava/lang/String;

    move-result-object v3

    invoke-static {p0, v0, v1}, Lkik/android/chat/vm/profile/cv;->a(Lkik/android/chat/vm/profile/cd;Ljava/lang/String;Lkik/android/chat/vm/ReportDialogViewModel$ReportContext;)Ljava/lang/Runnable;
    ...
    .line 3487
    invoke-direct {p0}, Lkik/android/chat/vm/profile/cd;->J()Lkik/core/datatypes/k;
    ...
    .line 3491
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->i:Lcom/kik/metrics/c/d;
...
.method static synthetic c(Lkik/android/chat/vm/profile/cd;Lcom/kik/core/domain/a/a/c;)V
    .locals 11
    ...
    invoke-virtual {p0, v0}, Lkik/android/chat/vm/profile/cd;->a(I)Ljava/lang/String;
    ...
    .line 331
    invoke-virtual {p0, v6}, Lkik/android/chat/vm/profile/cd;->a(I)Ljava/lang/String;

    move-result-object v6

    invoke-static {p0}, Lkik/android/chat/vm/profile/cy;->a(Lkik/android/chat/vm/profile/cd;)Ljava/lang/Runnable;
    ...
    .line 332
    invoke-static {v4}, Lkik/android/util/br;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    aput-object v4, v8, v9

    invoke-virtual {p0, v7, v8}, Lkik/android/chat/vm/profile/cd;->a(I[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v4

    invoke-static {p0}, Lkik/android/chat/vm/profile/cz;->a(Lkik/android/chat/vm/profile/cd;)Ljava/lang/Runnable;
    ...
    .line 3350
    :goto_0
    invoke-static {p0, v2, v1, v0}, Lkik/android/chat/vm/profile/co;->a(Lkik/android/chat/vm/profile/cd;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Runnable;
...
.method static synthetic d(Lkik/android/chat/vm/profile/cd;)V
    .locals 2
    ...
    invoke-interface {v0, v1}, Lkik/android/chat/vm/bd;->c(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic d(Lkik/android/chat/vm/profile/cd;Lcom/kik/core/domain/a/a/c;)V
    .locals 3
...
.method static synthetic e(Lkik/android/chat/vm/profile/cd;)V
    .locals 4
    ...
    .line 173
    invoke-virtual {p0, v2}, Lkik/android/chat/vm/profile/cd;->a(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/db;->a(Lkik/android/chat/vm/profile/cd;)Ljava/lang/Runnable;
...
.method static synthetic e(Lkik/android/chat/vm/profile/cd;Lcom/kik/core/domain/a/a/c;)V
    .locals 5
    ...
    .line 160
    invoke-virtual {p0}, Lkik/android/chat/vm/profile/cd;->E()V

    .line 161
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->z:Lkik/android/chat/vm/dz;
    ...
    .line 4189
    iget-boolean v2, p0, Lkik/android/chat/vm/profile/cd;->y:Z
    ...
    invoke-virtual {p0, v2}, Lkik/android/chat/vm/profile/cd;->a(Lkik/android/chat/vm/profile/do;)V
    ...
    .line 4195
    iget-object v2, p0, Lkik/android/chat/vm/profile/cd;->x:Lkik/core/datatypes/MemberPermissions;
    ...
    iget-object v2, p0, Lkik/android/chat/vm/profile/cd;->v:Lkik/core/interfaces/b;
    ...
    iget-object v2, p0, Lkik/android/chat/vm/profile/cd;->c:Lrx/subjects/a;

    invoke-direct {v0, v1, v2}, Lkik/android/chat/vm/profile/profileactionvm/ai$d;-><init>(Lcom/kik/core/network/xmpp/jid/a;Lrx/d;)V

    invoke-virtual {p0, v0}, Lkik/android/chat/vm/profile/cd;->a(Lkik/android/chat/vm/profile/do;)V
    ...
    iget-object v1, p0, Lkik/android/chat/vm/profile/cd;->A:Lrx/d;
    ...
    .line 167
    :cond_5
    invoke-virtual {p0}, Lkik/android/chat/vm/profile/cd;->k()V

    .line 168
    invoke-virtual {p0}, Lkik/android/chat/vm/profile/cd;->D()V
    ...
    .line 6240
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->D:Lrx/k;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/profile/cd;->D:Lrx/k;
    ...
    iget-object v2, p0, Lkik/android/chat/vm/profile/cd;->A:Lrx/d;

    iget-object v3, p0, Lkik/android/chat/vm/profile/cd;->B:Lcom/kik/core/network/xmpp/jid/a;

    invoke-direct {v1, v2, v3}, Lkik/android/chat/vm/profile/gridvm/ap;-><init>(Lrx/d;Lcom/kik/core/network/xmpp/jid/a;)V

    invoke-virtual {v0, v1}, Lkik/android/chat/vm/dz;->a(Lkik/android/chat/vm/ay;)V
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/dg;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/g;
    ...
    iget-object v3, p0, Lkik/android/chat/vm/profile/cd;->E:Lrx/functions/h;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/dh;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/g;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cf;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/g;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cg;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/b;

    move-result-object v1

    invoke-static {}, Lkik/android/chat/vm/profile/ch;->a()Lrx/functions/b;
...
.method static synthetic f(Lkik/android/chat/vm/profile/cd;)V
    .locals 1
...
.method static synthetic g(Lkik/android/chat/vm/profile/cd;)Lkik/android/chat/vm/bd;
    .locals 1
...
.method static synthetic h(Lkik/android/chat/vm/profile/cd;)Ljava/lang/String;
    .locals 1
...
.method static synthetic i(Lkik/android/chat/vm/profile/cd;)Ljava/lang/String;
    .locals 1
...
.method static synthetic j(Lkik/android/chat/vm/profile/cd;)Ljava/lang/String;
    .locals 1
...
.method static synthetic k(Lkik/android/chat/vm/profile/cd;)Lkik/android/chat/vm/bd;
    .locals 1
...
.method static synthetic l(Lkik/android/chat/vm/profile/cd;)Lkik/android/chat/vm/bd;
    .locals 1
...
.method public final G()Lkik/android/chat/vm/chats/profile/ds;
    ...
    .prologue
    .line 443
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->C:Lkik/android/chat/vm/chats/profile/ds;
...
.method public final H()Lrx/d;
    ...
    .prologue
    .line 456
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->A:Lrx/d;

    invoke-static {}, Lkik/android/chat/vm/profile/cu;->a()Lrx/functions/g;
...
.method public final K()Lrx/d;
    ...
    invoke-static {}, Lkik/android/chat/vm/profile/ct;->a()Lrx/functions/g;
...
.method public final a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bd;)V
    ...
    .prologue
    .line 130
    invoke-interface {p1, p0}, Lcom/kik/components/CoreComponent;->a(Lkik/android/chat/vm/profile/cd;)V
    ...
    invoke-virtual {p0, v0, p1}, Lkik/android/chat/vm/profile/cd;->a(Lkik/android/chat/vm/bu;Lcom/kik/components/CoreComponent;)Lkik/android/chat/vm/bu;

    .line 134
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->j:Lcom/kik/core/domain/a/c;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/profile/cd;->A:Lrx/d;

    .line 136
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->n:Lkik/core/xiphias/c;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cp;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/b;

    move-result-object v1

    invoke-static {}, Lkik/android/chat/vm/profile/da;->a()Lrx/functions/b;
    ...
    .line 138
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->r:Lkik/core/interfaces/ac;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/profile/cd;->B:Lcom/kik/core/network/xmpp/jid/a;

    .line 1526
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->v:Lkik/core/interfaces/b;
    ...
    invoke-direct {v0, v1, v2}, Lkik/android/chat/vm/chats/profile/cy;-><init>(Lcom/kik/core/network/xmpp/jid/a;Lrx/d;)V

    iput-object v0, p0, Lkik/android/chat/vm/profile/cd;->C:Lkik/android/chat/vm/chats/profile/ds;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/dc;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/b;

    move-result-object v2

    invoke-static {}, Lkik/android/chat/vm/profile/dd;->a()Lrx/functions/b;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/de;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/b;

    move-result-object v2

    invoke-static {p0}, Lkik/android/chat/vm/profile/df;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/b;
...
.method public final al_()V
    ...
    invoke-virtual {v0}, Lkik/android/chat/vm/dz;->al_()V
...
.method public final d()Lrx/d;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cs;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/g;
...
.method public final g()V
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cn;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/b;
...
.method public final r()Lrx/d;
    ...
    .prologue
    .line 286
    iget-object v0, p0, Lkik/android/chat/vm/profile/cd;->s:Lkik/core/interfaces/w;
...
.method public final t()Lrx/d;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cj;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/g;
...
.method public final u()Lrx/d;
    ...
    invoke-static {}, Lkik/android/chat/vm/profile/ck;->a()Lrx/functions/g;
...
.method public final v()V
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cm;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/b;
...
.method public final w_()V
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cr;->a(Lkik/android/chat/vm/profile/cd;)Lrx/functions/b;
